...
unsigned char  *inet_srcrt_init(int);
void	 inet_srcrt_print(unsigned char *, int);
...
int		 mcast_join(int, const SA *, socklen_t, const char *, unsigned int);
...
int		 mcast_set_if(int, const char *, unsigned int);
...
int		 Mcast_get_loop(int);
int		 Mcast_get_ttl(int);
void	 Mcast_set_if(int, const char *, unsigned int);
